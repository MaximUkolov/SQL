...
*/
CREATE DATABASE IF NOT EXISTS hw2; 	-- Создание БД, если она не была создана

USE hw2;							-- Используем БД  hw2
...
NULL - значение в SQL, которое обозначает отсутствие или неопределенность значения.
*/